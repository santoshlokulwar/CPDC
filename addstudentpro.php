...
?>
 ...
 <form action="addstudentpro.php" method="post">
<?php include('nav2.html');
include('config.php');
mysqli_select_db( $conn,"CPDC" );
$currentdate=date("Y-m-d");
$q="select * from programlist where datefrom>='$currentdate'";
               ...
               <div class="col-sm-12" style="margin-top: 10%;">
                                                <select required id="idselectsem" name="event" style="background:transparent;border:1px solid; font-color:black; color:black; padding: 10px;float: ;">
                                                  ...
                                                  <?php   while($row = mysqli_fetch_assoc($retval)) { ?>
                                                    ...
                                                    <option value="<?php echo $row['PID']; ?>" ><?php echo $row['Nameoftrainingprogram']; ?></option>
                ...
                <div class="col-sm-12" style="margin-top: 10%;">
                                             <a href="program.php"  class="btn" style="background-color: #f44336;
                                color: white;
                                padding: 15px 25px;
                                text-align: center;
...
// Loop to store and display values of individual checked checkbox.
        ...
        {
        $q="insert into attendance_program(PID,SID) values('$event','$selected')";
