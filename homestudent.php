...
<div>
  ...
  <ul class="nav nav-pills nav-stacked" style="margin-left: 0%;">
    ...
    <li><a href=".php" ><span class="glyphicon glyphicon-"></span> Schedule </a></li>
    <li><a href="feedback.php" ><span class="glyphicon glyphicon-"></span >  Feedback </a></li>
        <li><a href=".php" ><span class="glyphicon glyphicon-"></span> External Event </a></li>
